...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var track = carousel.querySelector('[data-services-track]');
    var prevButton = carousel.querySelector('[data-services-prev]');
    var nextButton = carousel.querySelector('[data-services-next]');
